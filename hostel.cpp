...
void hostel::about()
{
  system("cls");
  cout << "=====================================================================================\n";
  cout << "                    UNIVERSITY INSTITUTE OF ENGINEERING & TECHNOLOGY (UIET)         \n";
  cout << "                             Panjab University, Chandigarh                          \n";
  cout << "=====================================================================================\n\n";

  cout << "UIET is one of the premier engineering institutes of North India, established in 2002\n";
  cout << "as a part of Panjab University. It offers undergraduate, postgraduate and doctoral\n";
  cout << "programs in various disciplines of engineering and technology.\n\n";

  cout << "📌 Key Highlights:\n";
  cout << "-------------------------------------------------------------\n";
  cout << "- Located in Sector 25, South Campus of Panjab University\n";
  cout << "- Offers B.E., M.E., and Ph.D. programs in multiple branches\n";
  cout << "- Strong focus on research in AI, ML, IoT, and Cybersecurity\n";
  cout << "- Hosts technical fests like 'TechWeek', cultural events, etc.\n";
  cout << "- Excellent placement records and industry collaborations\n";
  cout << "- More than 1200+ enrolled students and experienced faculty\n";
  cout << "-------------------------------------------------------------\n\n";

  cout << "🔗 Website : https://uiet.puchd.ac.in/\n";
  cout << "🏛️  Address : UIET, Sector 25, South Campus, PU, Chandigarh - 160014\n";
  cout << "📞 Contact : +91-172-2541242\n";
...
void hostel::add_data()
{
  ...
  if (total == 0)
  {
    ...
    cin >> mess_bill;
    cout << "pending accommodation bill : ";
    cin >> accomo_bill;
